...
a calculadora tem como principal requisito FUNCIONAR, a calculadora ira ter as principais operacoes, soma , subtracao , divisao e multiplicacao. 
...
try: # se der erro vai execultar o except direto
  ...
  num1 = int(input("digite o primeiro num")) # pede um num
  num2 = int(input("digite o segundo num")) # pede outro num
...
#-----------------------------------------------------
  ...
  print(f"isto nao pode ser processado")
